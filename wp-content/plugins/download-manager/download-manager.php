...
function wpdm_downloadable_nsc($params){
    ...
    $html = "<div id='wpdm_file_{$id}' class='wpdm_file $template'>{$title}<div class='cont'>{$desc}{$loginform}<div class='btn_outer'><div class='btn_outer_c' style='{$bg}'><a class='btn_left $classrel $hc login-please' rel='noindex, nofollow, {$id}' title='{$data[title]}' href='$url'  >$link_label</a>";    
    ...
    $html = "<div id='wpdm_file_{$id}' class='wpdm_file $template'>{$title}<div class='cont'>{$desc}{$password_field}<div class='btn_outer'><div class='btn_outer_c' style='{$bg}'><a class='btn_left $classrel $hc' rel='noindex, nofollow, {$id}' title='{$data[title]}' href='$url'  >$link_label</a>";
    if($data['show_counter']!=0)
    $html .= "<span class='btn_right counter'>$data[download_count] downloads</span>";    
    else
